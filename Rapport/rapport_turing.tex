...
\lstinputlisting[language=c, firstline= 30, lastline =31]{Turing-In-C/Projet_Turing_legoueix.c}
...
\lstinputlisting[language=c, firstline =38, lastline =38]{Turing-In-C/Projet_Turing_legoueix.c}
